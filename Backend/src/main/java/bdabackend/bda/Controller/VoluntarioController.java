...
public class VoluntarioController {
    ...
    public void crearVoluntario(@RequestBody Map<String, String> body) {
        ...
        voluntarioService.insertarVoluntario(nombreVoluntario, correoVoluntario, numeroDocumentoVoluntario,
                zona, passwordEncoder.encode(contrasenaVoluntario), equipamientoVoluntario);
    }
